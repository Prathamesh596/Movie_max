...
import { API_KEY, getImageUrl } from '../constants/ApiConstants';
                        ...
                        data.map((val, index) => {
                            return (
                                <div className={`carousel-item ${index === 1 ? 'active' : ''} `} key={index}>
                                    <img src={getImageUrl(val.backdrop_path, 'max')} alt='Movie Poster'
                                        className='w-100 vh-100' />
                                    <div class="carousel-caption text-start col-lg-5 col-md-7 col-12 start-0 top-0 p-0 px-5" >
                                        <img src={getImageUrl(val.poster_path, 'min')}
                                            className='' height={300} alt={val.original_title} />
