...
export default function ContactUs() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!message || message.trim().length < 5) {
            toast.error('Message cannot be empty and should be at least 5 characters.');
            return;
        }
        ...
        try {
            ...
            console.log('Contact send response:', res?.data ?? res);
            ...
            if (serverMessage) toast.error(serverMessage);
                ...
                toast.error('Could not reach the server. Check backend is running (http://localhost:8080).');
            } else {
    ...
    return (
        <>
            <PageHero title="Get in touch" subtitle="We'd love to hear from you" image="/images/contactus.jpeg" height="32vh" />
            <div className="text-center my-5">
                ...
                <p style={{ fontSize: '1.1rem', color: '#555', marginTop: '15px' }}>
                    We're here to assist you with any questions related to MovieMax, an event ticketing platform.
