...
const AboutUs = () => {
    return (
        <>
            <PageHero title="About MovieMax" subtitle="Endless entertainment, curated for you" image="/images/theatre-photo.jpg" height="36vh" />
            <div className="container my-5">
                <div className="row gy-4">
                    ...
                    <div className="col-md-6">
                        <h2><strong>MovieMax :</strong><h3> Endless entertainment anytime anywhere </h3> </h2>
                        <hr></hr>
                        <p>
                            Welcome to <strong>MovieMax</strong>, your ultimate destination for all ticketing needs.
                            <strong> Endless Entertainment, Anytime, Anywhere</strong> is not just our slogan—it's our promise.
                        </p>
                        <hr></hr>
                        <p>
                            At <strong>MovieMax</strong>, we offer a seamless, hassle-free platform for booking tickets for a wide variety of events.
                        ...
                        <hr></hr>
                        <p>
                            At <strong>MovieMax</strong>, we aim to unite people with their favorite events effortlessly.
                        ...
                        <hr></hr>
                        <p>
                            <strong>MovieMax</strong> stands for reliability, ease, and excitement. Join us and let’s bring the entertainment world closer to you.
